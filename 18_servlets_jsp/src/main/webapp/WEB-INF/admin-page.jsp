            ...
            <c:forEach var="user" items="${usersList}">
                <tr>
                    ...
                    <td>
                        ...
                        <c:if test="${currentUser.login != user.login}">
                            <button data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-dark mx-2">Delete</button>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Are you sure? You want to delete user "${user.getFirstName()}" with login "${user.login}"..
                                        </div>
